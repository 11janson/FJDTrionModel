...
class CSUTILS_EXPORT FileIterator
{
public:
    class Item
    {
...
class CSUTILS_EXPORT FileListIterator : public FileIterator
{
public:
...
class CSUTILS_EXPORT SubDirFileIterator : public FileIterator
{
public:
...
class CSUTILS_EXPORT FileSearchResult
{
public:
    FileSearchResult() {}
...
CSUTILS_EXPORT QFuture<FileSearchResultList> findInFiles(const QString &searchTerm, FileIterator *files,
    QTextDocument::FindFlags flags, const QMap<QString, QString> &fileToContentsMap = QMap<QString, QString>());

CSUTILS_EXPORT QFuture<FileSearchResultList> findInFilesRegExp(const QString &searchTerm, FileIterator *files,
    QTextDocument::FindFlags flags, const QMap<QString, QString> &fileToContentsMap = QMap<QString, QString>());

CSUTILS_EXPORT QString expandRegExpReplacement(const QString &replaceText, const QStringList &capturedTexts);
CSUTILS_EXPORT QString matchCaseReplacement(const QString &originalText, const QString &replaceText);

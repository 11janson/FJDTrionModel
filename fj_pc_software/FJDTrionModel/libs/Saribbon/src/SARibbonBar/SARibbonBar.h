...
public:
	...
	//设置某个标签页不可用 janson.yang 2022.5.26
	void setCategorysEnabled(bool state, QString categoryObjectName = "", QString pannelObjectName = "", QString actionObjectName = "",QString ignoreObjectName = "");
signals:

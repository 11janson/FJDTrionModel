...
SARibbonStyleOption::SARibbonStyleOption()
{
    ...
    m_titleBarHeight                     = 26;
    m_tabBarHeight                       = 26;
    //m_ribbonbarHeightOfficeStyleThreeRow = m_titleBarHeight + m_tabBarHeight + (lineSpacing * 1.5) * 2.5
	...
	m_ribbonbarHeightOfficeStyleThreeRow = 170;
    recalc();
}

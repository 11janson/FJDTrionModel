...
private:
	//! Custom save method
	CC_FILE_ERROR saveToASCIIFile(ccGenericMesh* mesh, QFile& theFile, const SaveParameters& parameters);
	CC_FILE_ERROR saveToBINFile(ccGenericMesh* mesh, QFile& theFile, const SaveParameters& parameters);

...
ccPolyline* ccTracePolylineTool::polylineOverSampling(unsigned steps) const
{
	...
	FJframelessprocessdialog pDlg(QString("Oversampling"), "Cancel", 0, static_cast<int>(end_size), m_associatedWin ? m_associatedWin->asWidget() : nullptr);
	pDlg.setFixedWidth(350);

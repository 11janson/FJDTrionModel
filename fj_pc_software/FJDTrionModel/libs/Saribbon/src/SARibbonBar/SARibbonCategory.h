...
public:
	...
	//janson.yang
	void setPannelsEnabled(bool state, QString pannelObjectName = "", QString actionObjectName = "", QString ignoreObjectName = "");

signals:
    /**
    *@brief 
    */
    void signalLeveWindows(void);
 ...
 public:
    ...
    *@brief 判断是否已经进入该窗口模块
    */
    inline bool isEnterWindow() { return m_bEnterWindow; };

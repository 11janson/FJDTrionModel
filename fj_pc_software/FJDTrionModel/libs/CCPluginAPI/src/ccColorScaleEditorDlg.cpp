...
bool ccColorScaleEditorDialog::canChangeCurrentScale()
{
	...
	QMessageBox::StandardButton button = CS::Widgets::FramelessMessageBox::warning(this,
...
void ccColorScaleEditorDialog::exportCurrentScale()
{
	...
	//ask for a filename
	QString filename = CS::Widgets::FramelessFileDialog::getSaveFileName(this,"Select output file",currentPath,"*.xml");
	if (filename.isEmpty())
	{
...
void ccColorScaleEditorDialog::importScale()
{
	...
	//ask for a filename
	QString filename = CS::Widgets::FramelessFileDialog::getOpenFileName(this,"Select color scale file",currentPath,"*.xml");
	if (filename.isEmpty())
	{
		//process cancelled by user
		return;

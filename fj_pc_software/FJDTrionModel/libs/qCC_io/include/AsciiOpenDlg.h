...
const unsigned ASCII_OPEN_DLG_TYPES_COUNT = 23;
...
enum CC_ASCII_OPEN_DLG_TYPES {	ASCII_OPEN_DLG_None			= 0,
								...
								ASCII_OPEN_DLG_INTENSITY    = 19,
								ASCII_OPEN_DLG_GPSTIME		= 20,
								ASCII_OPEN_DLG_CLASSFICATION= 21,
...
class QCC_IO_LIB_API AsciiOpenDlg : public CS::Widgets::FramelessDialog
{
	Q_OBJECT
...
public:
	...
	void updateParam(int column, int index);
	//! Default constructor
...
protected:
	...
	void onSeparatorIndexChange(int index);

...
#define CC_DEFAULT_CLOUD_SHININESS			15.0f
...
public:
	...
	**/
	...
	//和carl沟通，默认参数先改成 false,避免目录树里出现octree--janson20231102
	virtual ccOctree::Shared computeOctree(CCCoreLib::GenericProgressCallback* progressCb = nullptr, bool autoAddChild = false);

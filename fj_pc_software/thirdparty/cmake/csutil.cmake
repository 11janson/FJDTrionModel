...
#
#   cs_check_package_found: Test varname-FOUND for case-insensitive varname
#
################################################################################
...
# uppercase.
#
macro(cs_check_package_found NAME SUCCESS)
  ...
  #message(STATUS "cs_check_package_found: ${SUCCESS}=${${SUCCESS}}")
endmacro()

#
# Pretty-print of given property of current directory.
#
function(cs_report_directory_property PROPNAME)
...
# For instance, on Windows, libraries get ABI version suffix cs_coreXY.{dll|lib}.
#
function(cs_target_output_name TARGET_NAME OUTPUT_NAME)

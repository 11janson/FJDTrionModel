...
option( OPTION_USE_GDAL "Build with GDAL support" ON )
if( ${OPTION_USE_GDAL} )
	...
	if ( NOT GDAL_FOUND )
        ...
        set(GDAL_LIBRARY_DEBUG "" CACHE FILEPATH "")#添加debug库路径 janson 2023-8-28
...
function( target_link_GDAL ) # ARGV0 = project name
    ...
    #janson 2023-8-28
    #通过关键字debug和optimized来区分配置，debug编译时链接GDAL_LIBRARY_DEBUG库，release编译时链接GDAL_LIBRARY库

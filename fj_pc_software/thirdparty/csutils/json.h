...
class CSUTILS_EXPORT JsonMemoryPool
{
public:
    ~JsonMemoryPool();
 ...
 */
class CSUTILS_EXPORT JsonValue
{
public:
    enum Kind {
        String,
 ...
 */
class CSUTILS_EXPORT JsonStringValue : public JsonValue
{
public:
 ...
 */
class CSUTILS_EXPORT JsonDoubleValue : public JsonValue
{
public:
 ...
 */
class CSUTILS_EXPORT JsonIntValue : public JsonValue
{
public:
 ...
 */
class CSUTILS_EXPORT JsonObjectValue : public JsonValue
{
public:
    JsonObjectValue()
        : JsonValue(Object)
 ...
 */
class CSUTILS_EXPORT JsonArrayValue : public JsonValue
{
public:
    JsonArrayValue()
        : JsonValue(Array)
 ...
 */
class CSUTILS_EXPORT JsonBooleanValue : public JsonValue
{
public:
...
class CSUTILS_EXPORT JsonNullValue : public JsonValue
{
public:
    JsonNullValue()
        : JsonValue(Null)
 ...
 *
 */
class CSUTILS_EXPORT JsonSchema
{
public:
 ...
 */
class CSUTILS_EXPORT JsonSchemaManager
{
public:

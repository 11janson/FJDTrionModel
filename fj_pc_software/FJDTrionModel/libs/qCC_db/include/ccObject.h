...
#define CC_VIEWPORT_BIT					0x00000000000040	//2D qviewport
...
#define CC_SHOWBOX_BIT					0x00001000000000 //janson.yang
#define CC_SURFACE_BIT					0x00002000000000 //mike.li
#define CC_CUBOIDS_BIT					0x00004000000000 //janson.yang
//#define CC_FREE_BIT					0x00008000000000
//#define CC_FREE_BIT					0x00010000000000
//#define CC_FREE_BIT					...
#define CC_NOTE_2D                      0x00020000000000
#define CC_LINEGROUP                    0x00040000000000
#define CC_LINES						0x00080000000000
#define CC_POINT                        0x00100000000000    ///<二维矢量控制点
#define CC_RECT                         0x00200000000000    ///<剖面框
#define CC_STATIC_LABEL                 0x00400000000000    ///<静态标签
...
namespace CC_TYPES
{
	enum : CC_CLASS_ENUM {
        ...
        NOTE_2D             =   HIERARCHY_OBJECT    | CC_NOTE_2D                | CC_LEAF_BIT,
        STATUC_LABEL        =   HIERARCHY_OBJECT    | CC_STATIC_LABEL           | CC_LEAF_BIT,
		RECT_3D             = HIERARCHY_OBJECT      | CC_RECT                   | CC_LEAF_BIT,
        POINT_C             =   HIERARCHY_OBJECT    | CC_POINT                  | CC_LEAF_BIT,
		SHOW_BOX			=	HIERARCHY_OBJECT	| CC_SHOWBOX_BIT			| CC_LEAF_BIT,//janson.yang
        ...
        CUBOIDS = PRIMITIVE | CC_CUBOIDS_BIT,                          //janson.yang
		CLIPPING_BOX_CUBE,
		...
		**/
        ...
        SURFACE             =   PRIMITIVE           | CC_SURFACE_BIT,
        LINEGROUP           =	HIERARCHY_OBJECT | CC_LINEGROUP,
		LINES				=	HIERARCHY_OBJECT | CC_LINES,
...
public:
	...
	**/
	...
	//! Returns object showname
	virtual inline bool getShowvolumn() const { return m_isshowvolumn; }

	//! Sets object showname
	virtual inline void setShowvolumn(const bool& isshow) { m_isshowvolumn = isshow; }

								...
								QWidget* parent/*=nullptr*/)
{
	...
	//	progressDlg->setWindowFlags(Qt::Window | Qt::FramelessWindowHint);
	//}
	...
	{
		dataCloud = CCCoreLib::MeshSamplingTools::samplePointsOnMesh(ccHObjectCaster::ToGenericMesh(data), s_defaultSampledPointsOnDataMesh,nullptr);
		if (!dataCloud)
		{
	...
	result = CCCoreLib::ICPRegistrationTools::Register(	modelCloud,
														...
														finalRMS,
														finalPointCount,
														static_cast<CCCoreLib::GenericProgressCallback*>(nullptr));

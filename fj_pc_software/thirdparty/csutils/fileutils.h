...
CSUTILS_EXPORT QDebug operator<<(QDebug dbg, const Utils::FileName &c);
...
class CSUTILS_EXPORT FileName : private QString
{
public:
    FileName();
...
CSUTILS_EXPORT QTextStream &operator<<(QTextStream &s, const FileName &fn);

using FileNameList = QList<FileName>;

class CSUTILS_EXPORT FileUtils {
public:
...
class CSUTILS_EXPORT FileReader
{
...
class CSUTILS_EXPORT FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
    FileSaverBase();
...
class CSUTILS_EXPORT FileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
class CSUTILS_EXPORT TempFileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
QT_BEGIN_NAMESPACE
CSUTILS_EXPORT uint qHash(const Utils::FileName &a);
QT_END_NAMESPACE

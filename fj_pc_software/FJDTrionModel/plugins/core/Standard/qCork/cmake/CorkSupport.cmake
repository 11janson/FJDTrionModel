...
function( target_link_cork ) # 1 argument: ARGV0 = project name
	if( CORK_RELEASE_LIBRARY_FILE AND MPIR_RELEASE_LIBRARY_FILE )
		...
		target_link_libraries( ${ARGV0} PRIVATE ${CORK_RELEASE_LIBRARY_FILE} ${MPIR_RELEASE_LIBRARY_FILE} )

		#optional: debug mode
		if ( CORK_DEBUG_LIBRARY_FILE AND MPIR_DEBUG_LIBRARY_FILE )
			target_link_libraries( ${ARGV0} PRIVATE ${CORK_DEBUG_LIBRARY_FILE} ${MPIR_DEBUG_LIBRARY_FILE} )
		endif()
	else()

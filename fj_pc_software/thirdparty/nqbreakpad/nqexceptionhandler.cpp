...
static ExceptionHandler::CrashCallback s_callback = nullptr;
 ...
 */
QString ExceptionHandler::getDumpDirDefault(const QString &appName,
 ...
 * @param bool 是否上传Dump
 * @param ExceptionHandler::CrashCallback 回调函数（软件崩溃时关闭Log日志）
 * @return 返回默认的Dump输出目录
 */
ExceptionHandler::ExceptionHandler(const QString &dumpFilePath,
    const QString &dumpReporterPath,
    bool bIsReport,
    const QString &appVersion,
    const QString &companyShortName,
    ExceptionHandler::CrashCallback callback)
{
 ...
 * @return 返回默认的Dump输出目录
 */
void ExceptionHandler::init(const QString &dumpFilePath,
    const QString &appVersion,
    const QString &dumpReporterPath,
    bool bIsReport,
    const QString &companyShortName,
    ExceptionHandler::CrashCallback callback)
{
    ...
    {
        qDebug() << "ExceptionHandler initialization failed!";
        return;
    }

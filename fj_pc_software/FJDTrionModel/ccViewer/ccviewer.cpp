...
bool ccViewer::checkStereoMode()
{
	...
	{
		if (CS::Widgets::FramelessMessageBox::question(this,"Stereo mode", "Stereo-mode only works in perspective mode. Do you want to enable it?", QMessageBox::Yes, QMessageBox::No) == QMessageBox::No)
		{
			return false;
		}
		else
...
{
	CS::Widgets::FramelessMessageBox msgBox;
	QString text;
	text += "Shortcuts:\n\n";

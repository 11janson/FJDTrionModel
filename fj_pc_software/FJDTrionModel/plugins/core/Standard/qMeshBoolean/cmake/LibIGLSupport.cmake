...
function( target_link_libIGL ) # 1 argument: ARGV0 = project name
	if( LIBIGL_RELEASE_LIBRARY_FILE )
		...
		target_link_libraries( ${ARGV0} PRIVATE ${LIBIGL_RELEASE_LIBRARY_FILE} )
		target_link_libraries( ${ARGV0} PRIVATE CGAL::CGAL CGAL::CGAL_Core)

		#optional: debug mode
		if ( LIBIGL_DEBUG_LIBRARY_FILE )
			target_link_libraries( ${ARGV0} PRIVATE ${LIBIGL_DEBUG_LIBRARY_FILE} )
			target_link_libraries( ${ARGV0} PRIVATE CGAL::CGAL CGAL::CGAL_Core)
		endif()
	else()

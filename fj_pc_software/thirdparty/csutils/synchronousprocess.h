...
class CSUTILS_EXPORT SynchronousProcessResponse
{
public:
    enum Result {
...
CSUTILS_EXPORT QDebug operator<<(QDebug str, const SynchronousProcessResponse &);

using ExitCodeInterpreter = std::function<SynchronousProcessResponse::Result(int /*exitCode*/)>;
CSUTILS_EXPORT SynchronousProcessResponse::Result defaultExitCodeInterpreter(int code);

class CSUTILS_EXPORT SynchronousProcess : public QObject
{
    Q_OBJECT
public:
    enum Flags {

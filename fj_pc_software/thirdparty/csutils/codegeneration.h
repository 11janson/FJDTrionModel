...
CSUTILS_EXPORT QString fileNameToCppIdentifier(const QString &s);

CSUTILS_EXPORT QString headerGuard(const QString &file);
CSUTILS_EXPORT QString headerGuard(const QString &file, const QStringList &namespaceList);
...
CSUTILS_EXPORT void writeBeginQtVersionCheck(QTextStream &str);

CSUTILS_EXPORT void writeQtIncludeSection(const QStringList &qt4,

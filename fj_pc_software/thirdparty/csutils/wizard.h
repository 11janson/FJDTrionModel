...
class CSUTILS_EXPORT Wizard : public QWizard
{
    Q_OBJECT
...
class CSUTILS_EXPORT WizardProgress : public QObject
{
    Q_OBJECT
...
class CSUTILS_EXPORT WizardProgressItem // managed by WizardProgress
{

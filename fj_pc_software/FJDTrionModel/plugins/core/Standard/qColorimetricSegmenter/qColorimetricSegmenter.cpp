						...
						unsigned thresholdDistance)
{
	...
	// compute distances
	CCCoreLib::DistanceComputationTools::Cloud2CloudDistancesComputationParams params = CCCoreLib::DistanceComputationTools::Cloud2CloudDistancesComputationParams();
	{

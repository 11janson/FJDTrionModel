	...
	**/
	...
	public:
		...
		**/
        ...
        CC_CORE_LIB_API ScalarType getValueByPercent(double percent);

        CC_CORE_LIB_API void getValueByPercentList(const std::vector<double> & percentlist, std::vector<ScalarType> & resultlist);
	protected: //methods

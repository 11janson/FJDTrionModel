...
struct ccGLDrawContext
{
    ...
    //! Label marker size (original)
    float labelOriginalMarkerSize;
    ...
    bool visibleEnable;
    bool isShowLodState = false;
    unsigned activeFboid;
    unsigned int meshNormalShaderProgram = 0;
    unsigned int pointcloudNormalShaderProgram = 0;
    unsigned int imageMeshShaderProgram = 0;
	//Default constructor
	ccGLDrawContext()
		: drawingFlags(0)
		, glW(0)

...
class CSUTILS_EXPORT Theme : public QObject
{
    Q_OBJECT
...
public:
    ...
    QString imageFile(const QString &imageKey, const QString &fallBack) const;
...
private:
    friend CSUTILS_EXPORT Theme *creatorTheme();
    friend CSUTILS_EXPORT Theme *proxyTheme();
    QPair<QColor, QString> readNamedColor(const QString &color) const;
};

CSUTILS_EXPORT Theme *creatorTheme();
CSUTILS_EXPORT Theme *proxyTheme();

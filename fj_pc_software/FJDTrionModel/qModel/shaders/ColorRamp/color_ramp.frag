...
void main(void)
{
	...
	else if(gl_Color[1] > 0.4)
	{
		unpackedValues[0] = gl_Color[0] ;
		unpackedValues[1] = gl_Color[2] ;
		unpackedValues[2] = gl_Color[3] ;
	}
	else //grayed point
	{
	...
	//gl_FragColor = vec4(gl_Color[2] * unpackedValues, 1.0);
}

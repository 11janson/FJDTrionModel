...
namespace CCCoreLib
{
	...
	**/
	class CC_CORE_LIB_API DgmOctree :/* public QObject,*/ public GenericOctree
	{
		/*Q_OBJECT*/
	public:
		...
		**/
		...
		static const int MAX_OCTREE_LEVEL = 15;//janson.yang 2022.6.9 八叉树最大层数改为15，网格所占内存最大8g左右
#else
	...
	public:	/***** CELLS POSITION HANDLING *****/
		...
		**/
		...
		/** The function to apply should be of the form DgmOctree::octreeCellFunc. In this case
			...
			\param progressCb the client application can get some notification of the process progress through this callback mechanism (see GenericProgressCallback)
			\param maxThreadCount the maximum number of threads to use (0 = all). Ignored if 'multiThread' is false or with tbb.

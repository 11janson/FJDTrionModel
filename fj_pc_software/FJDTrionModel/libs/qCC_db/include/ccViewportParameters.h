...
public: //functions
	...
	**/
	...
	inline void setEquivalentWidth(float width) { m_dViewEquivalentWidth = width; };

	inline double getEquivalentWidth() { return m_dViewEquivalentWidth; }

	inline float getAutoPointSize() {
		return m_fViewAutoPointSize;
    }
	inline void setAutoPointSize(float size) {
		m_fViewAutoPointSize = size;
    }
...
public: //variables
	...
	**/
    ...
    //[!]保存glWindow width
    double m_dViewEquivalentWidth;
    //[!]保存点大小
    float m_fViewAutoPointSize = 0.1f;

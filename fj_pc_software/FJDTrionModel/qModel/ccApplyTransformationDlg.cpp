...
void ccApplyTransformationDlg::checkMatrixValidityAndAccept()
{
	...
	if (!valid)
	{
		CS::Widgets::FramelessMessageBox::warning(this, "Invalid matrix", "Matrix is invalid. Make sure to only use white spaces or tabulations between the 16 elements");
		return;
	}
...
void ccApplyTransformationDlg::loadFromASCIIFile()
{
	...
	QString inputFilename = CS::Widgets::FramelessFileDialog::getOpenFileName(this, "Select input file", currentPath, "*.txt");

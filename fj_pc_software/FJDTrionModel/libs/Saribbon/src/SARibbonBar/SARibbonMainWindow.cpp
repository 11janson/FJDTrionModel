...
void SARibbonMainWindow::setMenuWidget(QWidget* menubar)
{
    ...
    //[!]这里是将窗口和Bar连接起来，处理鼠标移动bar，双击bar时，按钮的显示
    {
        connect(m_d->pFramelessHelper, &SAFramelessHelper::signalSetWindowGroupButtonState, m_d->windowButtonGroup, &SAWindowButtonGroup::setMaxButtonDisplayState,Qt::UniqueConnection);
    }
}

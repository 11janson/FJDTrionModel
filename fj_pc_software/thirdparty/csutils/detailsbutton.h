...
namespace Utils {
class CSUTILS_EXPORT FadingPanel : public QWidget
{
    Q_OBJECT
...
class CSUTILS_EXPORT FadingWidget : public FadingPanel
{
    Q_OBJECT
public:
...
class CSUTILS_EXPORT DetailsButton : public QAbstractButton
{
    Q_OBJECT

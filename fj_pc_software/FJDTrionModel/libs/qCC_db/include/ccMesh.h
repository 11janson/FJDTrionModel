...
public:
    ...
    //设置是否需要析构
    void setIsNeedReleas(bool isneedrelease) { m_isneedRealse = isneedrelease;}
    ...
    **/
    static ccMesh* Triangulate(ccGenericPointCloud* inputCloud,
        CCCoreLib::TRIANGULATION_TYPES type,
        bool updateNormals = false,
        PointCoordinateType maxEdgeLength = 0,
        unsigned char dim = 2);

    //Creates a surfacemesh from a pingtloud janson 2022.10.11
    static bool SufaceMesh(ccGenericPointCloud* cloud,
    ...
    **/
    ...
    //补洞，返回修补的洞数目
    int fillHoles(double max_hole_diam, int max_num_hole_edges, std::string tempFile, int& percent);
    /**
   *@brief 生成网格图片
   */
    QImage createMeshImage(void);
...
protected: //methods
    ...
    void drawData(CC_DRAW_CONTEXT& context);
    void drawDataNew(CC_DRAW_CONTEXT& context);
    void drawImage(CC_DRAW_CONTEXT& context);
...
protected: //members
    ...
    struct vertexArrayManager
    {
        ...
        std::vector<unsigned char> visibilityArray;

...
#define AdjustingleverScale   1.0f
...
public:
	...
	**/
	...
	inline ccBBox* getBoxPtr() { return &m_box; }
	...
	**/
	...
	void setUseClipPlanes(bool state) { isUseClipPlanes_ = state; }//2022.4.20 janson.yang
...
protected: //members
	...
	bool isUseClipPlanes_;
public:
	//[!]显示裁剪框内or外点云
	bool m_bDisPlayInorOutpoint = true;
private:
	//[!]绘制编辑框
	void drawPosition3D(CC_DRAW_CONTEXT& context, CCVector3, CCVector3, CCVector3);

	double  m_initialDistance = -1;
signals:
	void siganlSetResetToolButtonEnabel(bool);

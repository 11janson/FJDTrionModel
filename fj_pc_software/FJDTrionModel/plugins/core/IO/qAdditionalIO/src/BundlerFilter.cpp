												...
												float _scaleFactor/*=1.0f*/)
{
	...
	//Read Bundler '.out' file
	{
		...
		if (parameters.parentWidget)
		{
			...
			pDlg->setMethodTitle(QObject::tr("Opening Bundler file"));
	...
	if (parameters.parentWidget)
	{
		...
		ipDlg->setWindowFlags(Qt::Window | Qt::FramelessWindowHint);
	...
	if (generateColoredDTM)
	{
		...
		if (parameters.parentWidget)
		{
			...
			toDlg->setWindowFlags(Qt::Window | Qt::FramelessWindowHint);
